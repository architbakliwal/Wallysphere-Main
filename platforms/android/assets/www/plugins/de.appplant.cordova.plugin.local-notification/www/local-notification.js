...
exports.getSettings = function(success, error, options) {
    // this.exec('getSettings', notifications, callback, scope);
    cordova.exec(success, error, 'LocalNotification', 'getSettings', [options]);
};

exports.setSettings = function(options) {
    // this.exec('setSettings', notifications, callback, scope);
    cordova.exec(null, null, 'LocalNotification', 'setSettings', [options]);
};


exports.getScreenProperties = function(success, error, options) {
    // this.exec('getScreenProperties', notifications, callback, scope);
    cordova.exec(success, error, 'LocalNotification', 'getScreenProperties', [options]);
};

exports.setScreenProperties = function(options) {
    // this.exec('setScreenProperties', notifications, callback, scope);
